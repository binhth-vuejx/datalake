...
// GetSharedIssueTimeline returns the timeline for a shared issue (no auth required).
func (h *Handler) GetSharedIssueTimeline(w http.ResponseWriter, r *http.Request) {
