...
type HeartbeatResponse struct {
	...
	PendingMcpConfigWrite *PendingMcpConfigWrite  `json:"pending_mcp_config_write,omitempty"`
}

// PendingMcpConfigWrite is a request to write MCP config to the runtime's local config file.
type PendingMcpConfigWrite struct {
	McpConfig string `json:"mcp_config"` // JSON string, empty = clear
}
...
func (c *Client) SendHeartbeat(ctx context.Context, runtimeID string, mcpServers []McpServerInfo) (*HeartbeatResponse, error) {
