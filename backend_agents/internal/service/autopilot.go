...
func (s *AutopilotService) dispatchCreateIssue(ctx context.Context, ap db.Autopilot, run *db.AutopilotRun) error {
	...
	issueRow, err := qtx.CreateIssueWithOrigin(ctx, db.CreateIssueWithOriginParams{
	...
	// Convert CreateIssueWithOriginRow to Issue
	issue := db.Issue{
		ID:                 issueRow.ID,
		...
		AssigneeType:       issueRow.AssigneeType,
		AssigneeID:         issueRow.AssigneeID,
		CreatorType:        issueRow.CreatorType,
		CreatorID:          issueRow.CreatorID,
		ParentIssueID:      issueRow.ParentIssueID,
		AcceptanceCriteria: issueRow.AcceptanceCriteria,
		ContextRefs:        issueRow.ContextRefs,
		Position:           issueRow.Position,
		...
		OriginType:         issueRow.OriginType,
		OriginID:           issueRow.OriginID,
		FirstExecutedAt:    issueRow.FirstExecutedAt,
	}
