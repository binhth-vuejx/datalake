  ...
  return (
    <Tooltip>
      <TooltipTrigger
        onClick={handleClick}
        className={cn(
          "fixed bottom-2 right-2 z-[99995] flex size-10 cursor-pointer items-center justify-center rounded-full ring-1 ring-foreground/10 bg-card text-muted-foreground shadow-sm transition-transform hover:scale-110 hover:text-accent-foreground active:scale-95 pointer-events-auto",
