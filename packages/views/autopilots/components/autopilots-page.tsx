...
export function CreateAutopilotDialog({
  open,
  onOpenChange,
  template,
}: {
  ...
  const [executionMode, setExecutionMode] = useState<string>("create_issue");
        ...
        <div className="space-y-5 pt-2">
          ...
          <div>
            ...
            <Select value={executionMode} onValueChange={handleExecutionModeChange}>
              <SelectTrigger className="mt-1 w-full">
                <SelectValue>
                  {(value: string | null) => EXECUTION_MODE_LABELS[value ?? ""] ?? value ?? "Select mode..."}
                </SelectValue>
              </SelectTrigger>
              <SelectContent>
