...
import { useDeleteRuntime, useUpdateRuntimeMcpConfig } from "@multica/core/runtimes/mutations";
...
import { RuntimeMcpSection } from "./runtime-mcp-section";
...
export function RuntimeDetail({ runtime }: { runtime: AgentRuntime }) {
  ...
  const updateMcpMutation = useUpdateRuntimeMcpConfig(wsId);
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <RuntimeMcpSection
          runtime={runtime}
          canEdit={!!(isAdmin || isRuntimeOwner)}
          onSave={async (mcpConfig) => {
            await updateMcpMutation.mutateAsync({ runtimeId: runtime.id, mcpConfig });
          }}
          saving={updateMcpMutation.isPending}
        />
