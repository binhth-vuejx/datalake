...
const isOpenCodeRuntime = (runtimeDevice: RuntimeDevice | undefined) => {
  return runtimeDevice?.provider === "opencode";
};
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex border-b px-6">
        {detailTabs
          .filter((tab) => tab.id !== "mcp" || !isOpenCodeRuntime(runtimeDevice))
          .map((tab) => (
          <button
            key={tab.id}
