...
/**
 * Attempt to parse a string as a JSON ECharts option object.
 * Returns the parsed object on success, or null if the string is not valid JSON.
 */
    ...
    return {
      ...
      code: ({ className, children, ...props }) => {
        ...
        if (match || isBlock) {
          ...
          // ECharts block: attempt to parse and render as chart
          if (className === 'language-echarts') {
            const parsed = parseEChartsOption(code)
            if (parsed !== null) {
              return <EChartsChart option={parsed} className="echarts-chart-wrapper" />
            }
          }
