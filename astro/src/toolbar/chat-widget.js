...
var __privateMethod = (obj, member, method) => (__accessCheck(obj, member, "access private method"), method);
    ...
    object_keys(props_definition).forEach((prop) => {
      define_property(Class.prototype, prop, {
        ...
        set(value) {
          ...
          if (component) {
            var setter = (_a2 = get_descriptor(component, prop)) == null ? void 0 : _a2.get;
            if (setter) {
  ...
  var root_2 = /* @__PURE__ */ from_html(`<div class="empty svelte-1mbiiwd"><span class="empty-icon svelte-1mbiiwd">💬</span> <p class="svelte-1mbiiwd">Hỏi Multica bất cứ điều gì hoặc giao task cho agent.</p></div>`);
  var root_5 = /* @__PURE__ */ from_html(`<div class="bubble user-bubble svelte-1mbiiwd"> </div>`);
  var root_6 = /* @__PURE__ */ from_html(`<div class="bubble assistant-bubble svelte-1mbiiwd"> </div>`);
  var root_7 = /* @__PURE__ */ from_html(`<div class="bubble system-bubble svelte-1mbiiwd"> </div>`);
  var root_4 = /* @__PURE__ */ from_html(`<div><!></div>`);
  var root_8 = /* @__PURE__ */ from_html(`<div class="message assistant svelte-1mbiiwd"><div class="bubble assistant-bubble typing svelte-1mbiiwd"><span class="svelte-1mbiiwd"></span><span class="svelte-1mbiiwd"></span><span class="svelte-1mbiiwd"></span></div></div>`);
  var root_3 = /* @__PURE__ */ from_html(`<!> <!>`, 1);
  var root_10 = /* @__PURE__ */ from_html(`<button> </button>`);
  var root_9 = /* @__PURE__ */ from_html(`<div class="agent-dropdown svelte-1mbiiwd"></div>`);
  var root_1 = /* @__PURE__ */ from_html(`<div><div class="header svelte-1mbiiwd"><div class="header-left svelte-1mbiiwd"><span class="bot-icon svelte-1mbiiwd">🤖</span> <span class="title svelte-1mbiiwd"> </span></div> <div class="header-actions svelte-1mbiiwd"><button class="icon-btn svelte-1mbiiwd"> </button> <button class="icon-btn svelte-1mbiiwd" title="Xóa lịch sử">🗑</button> <button class="icon-btn svelte-1mbiiwd" title="Đóng">✕</button></div></div> <div class="messages svelte-1mbiiwd"><!></div> <div class="input-area svelte-1mbiiwd"><textarea placeholder="Tell me what to do..." rows="2" class="svelte-1mbiiwd"></textarea> <div class="input-footer svelte-1mbiiwd"><div class="agent-selector svelte-1mbiiwd"><button class="agent-btn svelte-1mbiiwd"><span class="agent-icon svelte-1mbiiwd">🤖</span> <span class="agent-name svelte-1mbiiwd"> </span> <span class="chevron svelte-1mbiiwd">▾</span></button> <!></div> <button class="send-btn svelte-1mbiiwd" title="Gửi (Enter)">↑</button></div></div></div>`);
  var root_11 = /* @__PURE__ */ from_svg(`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="svelte-1mbiiwd"><line x1="18" y1="6" x2="6" y2="18" class="svelte-1mbiiwd"></line><line x1="6" y1="6" x2="18" y2="18" class="svelte-1mbiiwd"></line></svg>`);
  var root_12 = /* @__PURE__ */ from_svg(`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1mbiiwd"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" class="svelte-1mbiiwd"></path></svg>`);
  var root = /* @__PURE__ */ from_html(`<div class="chat-widget svelte-1mbiiwd"><!> <button class="fab svelte-1mbiiwd" aria-label="Chat with Multica"><!></button></div>`);
  const $$css = {
    hash: "svelte-1mbiiwd",
    code: ".chat-widget.svelte-1mbiiwd {position:fixed;bottom:24px;right:80px; /* offset from persistent-widget */z-index:49;display:flex;flex-direction:column;align-items:flex-end;gap:8px;font-family:system-ui, -apple-system, sans-serif;}\n\n  /* ── Panel ── */.panel.svelte-1mbiiwd {background:#fff;border:1px solid #e5e7eb;border-radius:16px;width:340px;height:480px;box-shadow:0 8px 40px rgba(0,0,0,0.15);display:flex;flex-direction:column;overflow:hidden;transition:width 0.2s, height 0.2s;}.panel.expanded.svelte-1mbiiwd {width:480px;height:640px;}\n\n  /* ── Header ── */.header.svelte-1mbiiwd {display:flex;align-items:center;justify-content:space-between;padding:12px 14px;border-bottom:1px solid #f3f4f6;background:#fafafa;border-radius:16px 16px 0 0;}.header-left.svelte-1mbiiwd {display:flex;align-items:center;gap:8px;}.bot-icon.svelte-1mbiiwd {font-size:18px;}.title.svelte-1mbiiwd {font-weight:600;font-size:14px;color:#111827;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}.header-actions.svelte-1mbiiwd {display:flex;gap:4px;}.icon-btn.svelte-1mbiiwd {background:none;border:none;cursor:pointer;color:#9ca3af;font-size:14px;padding:4px 6px;border-radius:6px;line-height:1;transition:background 0.1s, color 0.1s;}.icon-btn.svelte-1mbiiwd:hover {background:#f3f4f6;color:#374151;}\n\n  /* ── Messages ── */.messages.svelte-1mbiiwd {flex:1;overflow-y:auto;padding:12px;display:flex;flex-direction:column;gap:8px;scroll-behavior:smooth;}.empty.svelte-1mbiiwd {flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;color:#9ca3af;text-align:center;gap:8px;}.empty-icon.svelte-1mbiiwd {font-size:32px;}.empty.svelte-1mbiiwd p:where(.svelte-1mbiiwd) {font-size:13px;margin:0;line-height:1.5;}.message.svelte-1mbiiwd {display:flex;}.message.user.svelte-1mbiiwd {justify-content:flex-end;}.bubble.svelte-1mbiiwd {max-width:85%;padding:8px 12px;border-radius:12px;font-size:13px;line-height:1.5;white-space:pre-wrap;word-break:break-word;}.user-bubble.svelte-1mbiiwd {background:#7c3aed;color:#fff;border-bottom-right-radius:4px;}.assistant-bubble.svelte-1mbiiwd {background:#f3f4f6;color:#111827;border-bottom-left-radius:4px;}.system-bubble.svelte-1mbiiwd {background:#fef3c7;color:#92400e;border-radius:8px;font-size:12px;}\n\n  /* Typing indicator */.typing.svelte-1mbiiwd {display:flex;gap:4px;align-items:center;padding:10px 14px;}.typing.svelte-1mbiiwd span:where(.svelte-1mbiiwd) {width:6px;height:6px;background:#9ca3af;border-radius:50%;\n    animation: svelte-1mbiiwd-bounce 1.2s infinite;}.typing.svelte-1mbiiwd span:where(.svelte-1mbiiwd):nth-child(2) {animation-delay:0.2s;}.typing.svelte-1mbiiwd span:where(.svelte-1mbiiwd):nth-child(3) {animation-delay:0.4s;}\n\n  @keyframes svelte-1mbiiwd-bounce {\n    0%, 60%, 100% { transform: translateY(0); }\n    30% { transform: translateY(-6px); }\n  }\n\n  /* ── Input area ── */.input-area.svelte-1mbiiwd {border-top:1px solid #f3f4f6;padding:10px 12px;background:#fff;border-radius:0 0 16px 16px;}textarea.svelte-1mbiiwd {width:100%;border:1px solid #e5e7eb;border-radius:10px;padding:8px 10px;font-size:13px;font-family:inherit;resize:none;outline:none;color:#111827;background:#f9fafb;box-sizing:border-box;transition:border-color 0.15s;line-height:1.5;}textarea.svelte-1mbiiwd:focus {border-color:#7c3aed;background:#fff;}textarea.svelte-1mbiiwd::placeholder {color:#9ca3af;}textarea.svelte-1mbiiwd:disabled {opacity:0.6;}.input-footer.svelte-1mbiiwd {display:flex;align-items:center;justify-content:space-between;margin-top:8px;}\n\n  /* ── Agent selector ── */.agent-selector.svelte-1mbiiwd {position:relative;}.agent-btn.svelte-1mbiiwd {display:flex;align-items:center;gap:4px;background:none;border:1px solid #e5e7eb;border-radius:20px;padding:4px 10px;font-size:12px;cursor:pointer;color:#374151;transition:border-color 0.15s;}.agent-btn.svelte-1mbiiwd:hover {border-color:#7c3aed;color:#7c3aed;}.agent-icon.svelte-1mbiiwd {font-size:14px;}.agent-name.svelte-1mbiiwd {max-width:100px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}.chevron.svelte-1mbiiwd {font-size:10px;color:#9ca3af;}.agent-dropdown.svelte-1mbiiwd {position:absolute;bottom:calc(100% + 4px);left:0;background:#fff;border:1px solid #e5e7eb;border-radius:10px;box-shadow:0 4px 16px rgba(0,0,0,0.1);min-width:160px;overflow:hidden;z-index:10;}.agent-option.svelte-1mbiiwd {display:block;width:100%;text-align:left;padding:8px 12px;font-size:12px;background:none;border:none;cursor:pointer;color:#374151;transition:background 0.1s;}.agent-option.svelte-1mbiiwd:hover {background:#f3f4f6;}.agent-option.selected.svelte-1mbiiwd {background:#ede9fe;color:#7c3aed;font-weight:600;}\n\n  /* ── Send button ── */.send-btn.svelte-1mbiiwd {width:32px;height:32px;border-radius:50%;background:#7c3aed;color:#fff;border:none;font-size:16px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background 0.15s, transform 0.1s;flex-shrink:0;}.send-btn.svelte-1mbiiwd:hover:not(:disabled) {background:#6d28d9;transform:scale(1.05);}.send-btn.svelte-1mbiiwd:disabled {background:#d1d5db;cursor:default;}\n\n  /* ── FAB ── */.fab.svelte-1mbiiwd {width:52px;height:52px;border-radius:50%;background:#fff;color:#374151;border:1px solid #e5e7eb;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,0.12);transition:transform 0.15s, box-shadow 0.15s;display:flex;align-items:center;justify-content:center;}.fab.svelte-1mbiiwd:hover {transform:scale(1.08);box-shadow:0 6px 20px rgba(0,0,0,0.18);}"
  };
  function ChatWidget2($$anchor, $$props) {
    push($$props, true);
    ...
    let agentDropdownOpen = /* @__PURE__ */ state(false);
    let workspaceSlug = /* @__PURE__ */ state(null);
    ...
    async function fetchAgents() {
      try {
        ...
        set(agents, (data == null ? void 0 : data.agents) ?? data ?? [], true);
        if (get(agents).length > 0 && !get(selectedAgent)) {
          set(selectedAgent, get(agents)[0], true);
        }
      } catch {
      }
    }
    async function sendMessage() {
      ...
      const slug = get(workspaceSlug) ?? getWorkspaceSlug();
      if (!slug) {
        set(
          messages,
          [
            ...
            {
              role: "system",
              content: "⚠️ Không tìm thấy workspace. Hãy mở một workspace trước."
            }
          ],
          true
        );
      ...
      set(messages, [...get(messages), { role: "user", content: text }], true);
      set(input, "");
      set(sending, true);
      try {
        const body = {
        ...
        if (get(selectedAgent)) body.agent_id = get(selectedAgent).id;
...
Agent sẽ xử lý ngay.`,
        ...
        set(
          ...
          [
            ...get(messages),
            { role: "system", content: `❌ Lỗi: ${e.message}` }
          ],
          true
        );
      } finally {
    ...
    function toggleOpen() {
      ...
      if (get(isOpen) && get(agents).length === 0) {
        set(workspaceSlug, getWorkspaceSlug(), true);
        fetchAgents();
      }
    }
      ...
      var consequent_5 = ($$anchor2) => {
        ...
        var node_1 = child(div_5);
        {
          ...
          var alternate_1 = ($$anchor3) => {
            ...
            each(node_2, 17, () => get(messages), index, ($$anchor4, msg) => {
              var div_7 = root_4();
              var node_3 = child(div_7);
              {
                var consequent_1 = ($$anchor5) => {
                  ...
                  reset(div_8);
                  template_effect(() => set_text(text_3, get(msg).content));
                ...
                var consequent_2 = ($$anchor5) => {
                  ...
                  reset(div_9);
                  template_effect(() => set_text(text_4, get(msg).content));
                ...
                var alternate = ($$anchor5) => {
                  ...
                  reset(div_10);
                  template_effect(() => set_text(text_5, get(msg).content));
                  append($$anchor5, div_10);
                };
                if_block(node_3, ($$render) => {
                  if (get(msg).role === "user") $$render(consequent_1);
                  else if (get(msg).role === "assistant") $$render(consequent_2, 1);
                  else $$render(alternate, -1);
                });
              }
              reset(div_7);
              template_effect(() => set_class(div_7, 1, `message ${get(msg).role ?? ""}`, "svelte-1mbiiwd"));
            ...
            var node_4 = sibling(node_2, 2);
            {
              ...
              if_block(node_4, ($$render) => {
                if (get(sending)) $$render(consequent_3);
              });
            }
        ...
        var node_5 = sibling(button_3, 2);
        {
          var consequent_4 = ($$anchor3) => {
            var div_15 = root_9();
            each(div_15, 21, () => get(agents), index, ($$anchor4, agent) => {
              ...
              template_effect(() => {
                var _a2;
                classes_1 = set_class(button_4, 1, "agent-option svelte-1mbiiwd", null, classes_1, { selected: ((_a2 = get(selectedAgent)) == null ? void 0 : _a2.id) === get(agent).id });
                set_text(text_7, `🤖 ${get(agent).name ?? ""}`);
              });
              delegated("click", button_4, () => {
                set(selectedAgent, get(agent), true);
                set(agentDropdownOpen, false);
              });
          ...
          if_block(node_5, ($$render) => {
            if (get(agentDropdownOpen) && get(agents).length > 0) $$render(consequent_4);
          });
        }
        reset(div_14);
        var button_5 = sibling(div_14, 2);
        reset(div_13);
        reset(div_12);
        reset(div_1);
        template_effect(
          ($0) => {
            var _a2, _b2;
            classes = set_class(div_1, 1, "panel svelte-1mbiiwd", null, classes, { expanded: get(isExpanded) });
            set_text(text_1, ((_a2 = get(selectedAgent)) == null ? void 0 : _a2.name) ?? "Ask Multica");
            set_attribute(button, "title", get(isExpanded) ? "Thu nhỏ" : "Mở rộng");
            set_text(text_2, get(isExpanded) ? "⊡" : "⊞");
            textarea.disabled = get(sending);
            set_text(text_6, ((_b2 = get(selectedAgent)) == null ? void 0 : _b2.name) ?? "Agent");
            button_5.disabled = $0;
          },
          [() => get(sending) || !get(input).trim()]
        );
        delegated("click", button, () => set(isExpanded, !get(isExpanded)));
        delegated("click", button_1, clearMessages);
        delegated("click", button_2, () => set(isOpen, false));
        delegated("keydown", textarea, handleKeydown);
        bind_value(textarea, () => get(input), ($$value) => set(input, $$value));
        delegated("click", button_3, () => set(agentDropdownOpen, !get(agentDropdownOpen)));
        delegated("click", button_5, sendMessage);
    ...
    var node_6 = child(button_6);
    {
      ...
      if_block(node_6, ($$render) => {
        if (get(isOpen)) $$render(consequent_6);
        else $$render(alternate_2, -1);
      });
    }
    reset(button_6);
    reset(div);
    delegated("click", button_6, toggleOpen);
    append($$anchor, div);
    pop();
  }
  delegate(["click", "keydown"]);
  customElements.define("chat-widget", create_custom_element(ChatWidget2, {}, [], [], { mode: "open" }));
  return ChatWidget2;
})();
